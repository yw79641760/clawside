...
{::nomarkdown}
{% include button-chrome.html text="Install on Chrome" link="https://chromewebstore.google.com/detail/clawside/mogffnoajeldmepekpaenegdfandigch" color="#4285F4" icon="true" %} {% include button.html text="View on GitHub" icon="github" link="https://github.com/yw79641760/clawside" color="#24292e" %}
{:/}
